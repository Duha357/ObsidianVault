# Источники для скилла `researcher`

Точки входа, не предел. Домена или класса нет в таблицах — определи источники методом «2.3. Автоопределение экосистемы» из `SKILL.md`.

Каждый источник отсюда проходит верификацию по «3.4. Верификация SIFT» и получает вес по «3.3. Вес источника».

## Расширенные классы источников

Колонку «Применимость» заполняй при аудите баланса: да, нет или частично.
